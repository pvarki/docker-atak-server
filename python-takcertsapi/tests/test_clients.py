...
def test_list_clients(client: TestClient, muck_cert_paths: None) -> None:
...
def test_get_client(client: TestClient, muck_cert_paths: None) -> None:
...
def test_post_client_exists(client: TestClient, temp_cert_path: None) -> None:
...
def test_post_client(client: TestClient, temp_cert_path: None, clientname: str) -> None:
...
def test_post_client_badnames(client: TestClient, temp_cert_path: None, clientname: str) -> None:
    """Test creating new pkg with invalid name"""
    _ = temp_cert_path
    resp = client.post("/api/v1/clients", json={"name": clientname})
